...
export default function QuoteCartPage() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (items.length === 0) {
      setFormError("Giỏ báo giá đang trống. Vui lòng thêm sản phẩm trước khi gửi yêu cầu.");
      return;
    }
    ...
    return (
      <div className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6 lg:px-8">
        ...
        <h1 className="mt-4 text-2xl font-bold text-slate-900">
          Giỏ báo giá đang trống
        </h1>
        <p className="mt-2 text-sm text-slate-600">
          Hãy thêm sản phẩm bạn quan tâm vào giỏ báo giá để gửi yêu cầu tư
          vấn giá.
        </p>
        <Link
          href="/san-pham"
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-extrabold text-slate-900">Giỏ báo giá</h1>
      <p className="mt-2 text-sm text-slate-600">
        Xem lại danh sách sản phẩm và điền thông tin để gửi yêu cầu báo giá.
      </p>
