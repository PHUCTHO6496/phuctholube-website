...
export async function updateSiteSettings(input: SettingsInput): Promise<SettingsResult> {
  ...
  const data = {
    ...
    statYearsLabelEn: parsed.data.statYearsLabelEn || null,
    statVolumeLabelEn: parsed.data.statVolumeLabelEn || null,
    statQualityLabelEn: parsed.data.statQualityLabelEn || null,
